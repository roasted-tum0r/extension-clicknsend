      ...
      <div className="absolute top-0 w-full flex justify-between items-start -mt-2">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className={`p-2 transition-all duration-200 cursor-pointer -ml-2 w-10 h-10 flex items-center justify-center rounded-xl
          ...
          {isMenuOpen && (
            <div className="absolute left-0 top-12 w-64 origin-top-left animate-dropdown-enter z-50 text-left cursor-default">
              <div className="bg-white/90 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-4 ring-1 ring-black/5">
